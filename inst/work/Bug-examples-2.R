...
## 1. Test case 1: Issue with to slow plotting in FSM()
##
...
## 2. Test case 2: General issue with TCLUST
##
...
## 3. Test case 3: An error in fsmult() with a specific data set: 'geyser' from MASS
library(fsdaR)
library(MASS)
data(geyser2)
data(geyser)
