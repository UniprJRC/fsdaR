...
/**
 * The <code>Fsda</code> class provides a Java interface to the M-functions
 * from the files:
 * <pre>
 ...
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>Fsda</code> instance when 
 * it is no longer needed to ensure that native resources allocated by this class are 
 * properly freed.
 * @version 0.0
 */
public class Fsda extends MWComponentInstance<Fsda>
{
    /**
    ...
    /**
     * Maintains information used in calling the <code>FSR</code> M-function.
     */
    private static final MWFunctionSignature sFSRSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                ...
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSRBeda</code> M-function.
     */
    private static final MWFunctionSignature sFSRBedaSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "FSRBeda",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSRBmdr</code> M-function.
     */
    private static final MWFunctionSignature sFSRBmdrSignature =
        new MWFunctionSignature(/* max outputs = */ 5,
                                /* has varargout = */ false,
                                /* function name = */ "FSRBmdr",
                                /* max inputs = */ 7,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSRbsb</code> M-function.
     */
    private static final MWFunctionSignature sFSRbsbSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ false,
                                /* function name = */ "FSRbsb",
                                /* max inputs = */ 4,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSReda</code> M-function.
     */
    private static final MWFunctionSignature sFSRedaSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "FSReda",
                                /* max inputs = */ 4,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSRenvmdr</code> M-function.
     */
    private static final MWFunctionSignature sFSRenvmdrSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "FSRenvmdr",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>FSRmdr</code> M-function.
     */
    private static final MWFunctionSignature sFSRmdrSignature =
        new MWFunctionSignature(/* max outputs = */ 5,
                                /* has varargout = */ false,
                                /* function name = */ "FSRmdr",
                                /* max inputs = */ 4,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>levfwdplot</code> M-function.
     */
    private static final MWFunctionSignature sLevfwdplotSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "levfwdplot",
                                /* max inputs = */ 2,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>LXS</code> M-function.
     */
    private static final MWFunctionSignature sLXSSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ true,
                                /* function name = */ "LXS",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>mdrplot</code> M-function.
     */
    private static final MWFunctionSignature sMdrplotSignature =
        new MWFunctionSignature(/* max outputs = */ 0,
                                /* has varargout = */ false,
                                /* function name = */ "mdrplot",
                                /* max inputs = */ 2,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>MMreg</code> M-function.
     */
    private static final MWFunctionSignature sMMregSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ true,
                                /* function name = */ "MMreg",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>MMregcore</code> M-function.
     */
    private static final MWFunctionSignature sMMregcoreSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "MMregcore",
                                /* max inputs = */ 5,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>MMregeda</code> M-function.
     */
    private static final MWFunctionSignature sMMregedaSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ true,
                                /* function name = */ "MMregeda",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>resfwdplot</code> M-function.
     */
    private static final MWFunctionSignature sResfwdplotSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "resfwdplot",
                                /* max inputs = */ 2,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>resindexplot</code> M-function.
     */
    private static final MWFunctionSignature sResindexplotSignature =
        new MWFunctionSignature(/* max outputs = */ 0,
                                /* has varargout = */ false,
                                /* function name = */ "resindexplot",
                                /* max inputs = */ 2,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>Score</code> M-function.
     */
    private static final MWFunctionSignature sScoreSignature =
        new MWFunctionSignature(/* max outputs = */ 1,
                                /* has varargout = */ false,
                                /* function name = */ "Score",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>Sreg</code> M-function.
     */
    private static final MWFunctionSignature sSregSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ true,
                                /* function name = */ "Sreg",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
    /**
     * Maintains information used in calling the <code>Sregeda</code> M-function.
     */
    private static final MWFunctionSignature sSregedaSignature =
        new MWFunctionSignature(/* max outputs = */ 2,
                                /* has varargout = */ true,
                                /* function name = */ "Sregeda",
                                /* max inputs = */ 3,
                                /* has varargin = */ true);
     ...
     */
    private Fsda (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(Fsda.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>Fsda</code> class.
     */
    public Fsda() throws MWException
    {
        this(Fsda4javaMCRFactory.newInstance());
    }
    ...
    /**
     * @deprecated Please use the constructor {@link #Fsda(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     */
    public Fsda(String pathToComponent) throws MWException
    {
        this(Fsda4javaMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>Fsda</code> class. Use this constructor to 
     ...
     */
    public Fsda(MWComponentOptions componentOptions) throws MWException
    {
        this(Fsda4javaMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = Fsda4javaMCRFactory.newInstance();
            mcr.runMain( sFSRSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>FSR</code> M-function 
     ...
     */
    public void FSR(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSR(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSR</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSR(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRSignature), 
                    sFSRSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSRBeda</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRBeda(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRBedaSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRBeda(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRBedaSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSRBeda</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSRBeda(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRBedaSignature), 
                    sFSRBedaSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSRBmdr</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRBmdr(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRBmdrSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRBmdr(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRBmdrSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSRBmdr</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSRBmdr(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRBmdrSignature), 
                    sFSRBmdrSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSRbsb</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRbsb(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRbsbSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRbsb(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRbsbSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSRbsb</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSRbsb(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRbsbSignature), 
                    sFSRbsbSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSReda</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSReda(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRedaSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSReda(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRedaSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSReda</code>
     * M-function with 4 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSReda(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRedaSignature), 
                    sFSRedaSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSRenvmdr</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRenvmdr(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRenvmdrSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRenvmdr(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRenvmdrSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSRenvmdr</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSRenvmdr(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRenvmdrSignature), 
                    sFSRenvmdrSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>FSRmdr</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRmdr(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFSRmdrSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FSRmdr(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFSRmdrSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FSRmdr</code>
     * M-function with 4 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FSRmdr(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFSRmdrSignature), 
                    sFSRmdrSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>levfwdplot</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void levfwdplot(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sLevfwdplotSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void levfwdplot(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sLevfwdplotSignature);
    }

    /**
     * Provides the standard interface for calling the <code>levfwdplot</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] levfwdplot(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sLevfwdplotSignature), 
                    sLevfwdplotSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>LXS</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void LXS(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sLXSSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void LXS(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sLXSSignature);
    }

    /**
     * Provides the standard interface for calling the <code>LXS</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] LXS(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sLXSSignature), 
                    sLXSSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>mdrplot</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void mdrplot(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sMdrplotSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void mdrplot(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sMdrplotSignature);
    }

    /**
     * Provides the standard interface for calling the <code>mdrplot</code>
     * M-function with 2 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] mdrplot(Object... rhs) throws MWException
    {
        Object[] lhs = new Object[0];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sMdrplotSignature), 
                    sMdrplotSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>MMreg</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMreg(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sMMregSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMreg(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sMMregSignature);
    }

    /**
     * Provides the standard interface for calling the <code>MMreg</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] MMreg(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sMMregSignature), 
                    sMMregSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>MMregcore</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMregcore(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sMMregcoreSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMregcore(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sMMregcoreSignature);
    }

    /**
     * Provides the standard interface for calling the <code>MMregcore</code>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] MMregcore(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sMMregcoreSignature), 
                    sMMregcoreSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>MMregeda</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMregeda(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sMMregedaSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void MMregeda(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sMMregedaSignature);
    }

    /**
     * Provides the standard interface for calling the <code>MMregeda</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] MMregeda(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sMMregedaSignature), 
                    sMMregedaSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>resfwdplot</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void resfwdplot(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sResfwdplotSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void resfwdplot(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sResfwdplotSignature);
    }

    /**
     * Provides the standard interface for calling the <code>resfwdplot</code>
     * M-function with 2 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] resfwdplot(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sResfwdplotSignature), 
                    sResfwdplotSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>resindexplot</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void resindexplot(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sResindexplotSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void resindexplot(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sResindexplotSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] resindexplot(Object... rhs) throws MWException
    {
        Object[] lhs = new Object[0];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sResindexplotSignature), 
                    sResindexplotSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>Score</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Score(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sScoreSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Score(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sScoreSignature);
    }

    /**
     * Provides the standard interface for calling the <code>Score</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] Score(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sScoreSignature), 
                    sScoreSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>Sreg</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Sreg(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sSregSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Sreg(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sSregSignature);
    }

    /**
     * Provides the standard interface for calling the <code>Sreg</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] Sreg(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sSregSignature), 
                    sSregSignature);
        return lhs;
    }
    /**
     * Provides the interface for calling the <code>Sregeda</code> M-function 
     * where the first input, an instance of List, receives the output of the M-function and
     * the second input, also an instance of List, provides the input to the M-function.
     * <p>M-documentation as provided by the author of the M function:
     * <pre>
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Sregeda(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sSregedaSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void Sregeda(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sSregedaSignature);
    }

    /**
     * Provides the standard interface for calling the <code>Sregeda</code>
     * M-function with 3 input arguments.
     * Input arguments may be passed as sub-classes of
     * <code>com.mathworks.toolbox.javabuilder.MWArray</code>, or as arrays of
     * any supported Java type. Arguments passed as Java types are converted to
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] Sregeda(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sSregedaSignature), 
                    sSregedaSignature);
        return lhs;
    }
}
